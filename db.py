...
def init_db():
    ...
    _METAS_DEFAULT = [
        ...
        ("fat_anual",       100000.0,"Meta de faturamento anual (R$)"),
    ...
    # Migração: atualiza fat_anual de 150000 para 100000
    c.execute("UPDATE metas SET valor=100000 WHERE chave='fat_anual' AND valor=150000")
    ...
    AVIAMENTOS_SEED = [
        ...
        ("Etiqueta Comprida",      "etiqueta",  "unidade", 0.08),
        ("Etiqueta Quadrada",      "etiqueta",  "unidade", 0.05),
        ("Etiqueta com dobra",     "etiqueta",  "unidade", 0.06),
        ("Etiqueta de composição", "etiqueta",  "unidade", 0.20),
